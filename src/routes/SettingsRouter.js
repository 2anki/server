...
const CardOptionsController_1 = __importDefault(require("../controllers/CardOptionsController/CardOptionsController"));
const SettingsRepository_1 = __importDefault(require("../data_layer/SettingsRepository"));
...
const SettingsRouter = () => {
    ...
    const controller = new CardOptionsController_1.default(new SettingsService_1.default(new SettingsRepository_1.default(database)));
    /**
     * @swagger
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.post('/api/settings/create/:id', RequireAuthentication_1.default, (req, res) => controller.createSetting(req, res));
    /**
     * @swagger
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.post('/api/settings/delete/:id', RequireAuthentication_1.default, (req, res) => controller.deleteSetting(req, res));
    /**
     * @swagger
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.get('/api/settings/find/:id', RequireAuthentication_1.default, (req, res) => controller.findSetting(req, res));
    /**
     * @swagger
