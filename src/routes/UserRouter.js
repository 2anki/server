...
const UserRouter = () => {
    ...
    const controller = new UsersControllers_1.default(new UsersService_1.default(new UsersRepository_1.default(database), emailService), authService);
     ...
     */
    router.post('/api/users/new-password', (req, res, next) => controller.newPassword(req, res, next));
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.post('/api/users/forgot-password', (req, res, next) => controller.forgotPassword(req, res, next));
    /**
     * @swagger
     * /api/users/logout:
     *   post:
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.post('/api/users/logout', RequireAuthentication_1.default, (req, res, next) => controller.logOut(req, res, next));
    /**
     * @swagger
     * /api/users/login:
     *   post:
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.post('/api/users/login', (req, res, next) => controller.login(req, res, next));
    /**
     * @swagger
     * /api/users/register:
     *   post:
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.post('/api/users/register', (req, res, next) => controller.register(req, res, next));
    /**
     * @swagger
     * /api/users/r/{id}:
     *   get:
     ...
     */
    router.get('/api/users/r/:id', (req, res, next) => controller.resetPassword(req, res, next));
    /**
     * @swagger
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.post('/api/users/delete-account', RequireAuthentication_1.default, (req, res) => controller.deleteAccount(req, res));
    /**
     * @swagger
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.get('/api/users/debug/locals', RequireAuthentication_1.default, (req, res) => controller.getLocals(req, res));
    /**
     * @swagger
     * /login:
     *   get:
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.post('/api/users/link_email', RequireAuthentication_1.default, (req, res) => controller.linkEmail(req, res));
    /**
     * @swagger
     ...
     */
    router.get('/api/users/auth/google', (req, res) => controller.loginWithGoogle(req, res));
    /**
     * @swagger
     * /api/users/avatar:
     *   get:
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.get('/api/users/avatar', RequireAuthentication_1.default, (req, res) => controller.getAvatar(req, res));
    return router;
};
