...
const RequirePaying_1 = __importDefault(require("./middleware/RequirePaying"));
const NotionController_1 = __importDefault(require("../controllers/NotionController"));
...
const NotionRouter = () => {
    ...
    const repository = new NotionRespository_1.default((0, data_layer_1.getDatabase)());
    const controller = new NotionController_1.default(new NotionService_1.default(repository));
    /**
     ...
     */
    router.get('/api/notion/connect', RequireAuthentication_1.default, (req, res) => controller.connect(req, res));
    /**
     * @swagger
     * /api/notion/pages:
     *   post:
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.post('/api/notion/pages', RequireAuthentication_1.default, (req, res) => controller.search(req, res));
    /**
     * @swagger
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.get('/api/notion/get-notion-link', RequireAuthentication_1.default, (req, res) => controller.getNotionLink(req, res));
    /**
     * @swagger
     * /api/notion/convert/:
     *   post:
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.post('/api/notion/convert/', RequireAuthentication_1.default, (req, res) => controller.convert(req, res));
    /**
     * @swagger
     * /api/notion/page/{id}:
     *   get:
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.get('/api/notion/page/:id', RequireAuthentication_1.default, (req, res) => controller.getPage(req, res));
    /**
     * @swagger
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.get('/api/notion/blocks/:id', RequireAuthentication_1.default, (req, res) => controller.getBlocks(req, res));
    /**
     * @swagger
     * /api/notion/block/{id}:
     *   get:
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.get('/api/notion/block/:id', RequireAuthentication_1.default, (req, res) => controller.getBlock(req, res));
    router.post('/api/notion/block/:id', RequireAuthentication_1.default, (req, res) => controller.createBlock(req, res));
    router.delete('/api/notion/block/:id', RequirePaying_1.default, (req, res) => controller.deleteBlock(req, res));
    /**
     * @swagger
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.get('/api/notion/render-block/:id', RequirePaying_1.default, (req, res) => controller.renderBlock(req, res));
    /**
     * @swagger
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.get('/api/notion/database/:id', RequireAuthentication_1.default, (req, res) => controller.getDatabase(req, res));
    /**
     * @swagger
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.get('/api/notion/database/query/:id', RequireAuthentication_1.default, (req, res) => controller.queryDatabase(req, res));
    /**
     * @swagger
     ...
     *               $ref: '#/components/schemas/Error'
     */
    router.post('/api/notion/disconnect', RequireAuthentication_1.default, (req, res) => controller.disconnect(req, res));
    return router;
};
