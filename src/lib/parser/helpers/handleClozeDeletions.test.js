...
const handleClozeDeletions_1 = __importDefault(require("./handleClozeDeletions"));
describe('handleClozeDeletions', () => {
    it('should handle already formatted cloze deletions', () => {
        ...
        expect((0, handleClozeDeletions_1.default)(input)).toBe(expected);
    });
...
//# sourceMappingURL=handleClozeDeletions.test.js.map